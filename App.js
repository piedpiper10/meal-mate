  ...
  return (
    <div className="header">
      <div className="logo-cotainer">
        <img
          className="logo"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXFn3hDo953YQD7NxIZMuJ1OgFck_JGEu5SA&s"
        />
      </div>
...
const resObj = [
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2025-02-19 01:00:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
    ...
    analytics: {
      context: "seo-data-bc267df3-2656-4012-98bb-c82587047644",
    },
    cta: {
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2025-02-19 00:00:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/10/16/ab4418b9-a3a0-4a9b-9d20-1aab5d9ff244_973614.jpg",
    ...
    cta: {
      link: "https://www.swiggy.com/city/bangalore/good-flippin-burgers-unit-no-sf-cn-09-koramangala-rest973614",
      text: "RESTAURANT_MENU",
      type: "WEBLINK",
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2025-02-18 23:59:00",
        opened: true,
      },
      badges: {
        textExtendedBadges: [
    ...
    <div className="res-card" style={{ backgroundColor: "#f0f0f0" }}>
      <img
        ...
        src={
          ...
          props.resInfo.info.cloudinaryImageId
        }
      />
      <h3>{name}</h3>
      <h4>{cuisines.join(", ")}</h4>
